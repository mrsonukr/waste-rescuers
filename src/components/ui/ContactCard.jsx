    ...
    >
      <div className="space-y-4 text-white">
        ...
        >
          ...
          professional service that's tailored to you. No hassle, just one simple
          click!" Would you like a more formal tone or a playful style?
        </p>
        <div
        ...
        >
          <div className="flex items-center justify-center gap-2">
            ...
            <a href="tel:+917061543815">+91 70615 43815</a>
          </div>
        </div>
        <div
